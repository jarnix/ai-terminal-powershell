...
- Windows with [Windows Terminal](https://aka.ms/terminal) (or any host running PowerShell)
...
- An [Anthropic API key](https://console.anthropic.com/) — or an OpenAI key / local Ollama install if you swap providers

## Installation

1. Download [`ai-terminal.ps1`](./ai-terminal.ps1) to a stable location, e.g. `~\ai-terminal.ps1`.

2. Set your API key once (persists across sessions):
...
3. Load the script from your PowerShell profile:
